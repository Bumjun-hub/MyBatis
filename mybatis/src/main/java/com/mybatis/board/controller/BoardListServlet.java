...
public class BoardListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		/*
		 * // totalRecord : 현재 총 게시글의 갯수 ( ex) 25) // nowPage : 현재 페이지(즉, 사용자가 요청한 페이지)
		 * // numPerPage : 현재 페이지에 보여줄 게시글의 최대갯수 (5) // pagePerBlock : 페이지 하단에 보여질 페이징바의
		 * 페이지 개수 (5) // // 위의 4개를 가지고 값을 구함 // totalPage : 가장 마지막 페이지(총 페이지 수) => 6 //
		 * startPage : 하단에 페이징바의 시작 페이지 // endPage : 하단에 페이징바의 끝 페이지
		 */
