...
public class BoardDao {
	...
	public ArrayList<Board> selectList(SqlSession sqlSession, PageInfo pi) {
		//
		/*
		 * offset : 몇개의 게시글을 건너뛰고 조회 할 건인지에 대한 값 limit : 조회할 숫자 ex) numPerPage : 5
		 * offset limit nowPage : 1 1~5 0 5 nowPage : 2 6~10 5 5 nowPage : 3 11~15 10 5
...
//		return list;
//		-->
		return (ArrayList)sqlSession.selectList("boardMapper.selectList", null, rowBounds); // xml의 네임 스페이스
	}
	// update 시 : sqlSession.update()
